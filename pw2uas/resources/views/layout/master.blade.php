...
<img src="{{ asset('dist/img/pg.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
<span class="brand-text font-weight-light">Toko Alat Musik SY</span>
</a>
...
<li class="nav-item">
  <a href="{{ url('alatmusik') }}" class="nav-link">
  ...
  <li class="nav-item">
    <a href="{{ url('tipealat') }}" class="nav-link">
    ...
    <li class="nav-item">
      <a href="{{ url('stockalat') }}" class="nav-link">
